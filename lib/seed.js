...
export const SEED_ENTRIES = [
  {
    ...
    data: { mood:"hopeful", weight_lb:180, notes:["Last known weight; current weight may be lower."] }
  },
  {
    ...
    data: { mood:"hurt", people:["Justin"], relationship_event:"clarity", notes:["Wants reciprocal emotional investment."] }
  },
  {
    ...
    categories: ["relationships","mind","growth"],
    data: { mood:"grief", people:["Nat"], relationship_event:"pregnancy support", notes:["Needs sustainable boundaries while staying loving."] }
  },
  {
    ...
    data: { workout_minutes:12, exercises:["band curls","pull-aparts","kickbacks","side steps","squats","calf raises"], strength_reps:90 }
  },
  {
    ...
    categories: ["body","fun"],
    data: { calories:1850, protein_g:70, miles:0.5, flights:4, workout_minutes:25, exercises:["light swimming","walking","stairs"] }
  },
  {
    ...
    data: { squats:50, strength_reps:100, miles:2, workout_minutes:55, exercises:["squats","curls","push-ups","incline treadmill"] }
  },
  {
    ...
    categories: ["body","growth"],
    data: { squats:60, strength_reps:120, workout_minutes:35, exercises:["squats","push-ups","stair master","weighted squats","curls","shoulder lifts","planks","stretching"] }
  },
  {
  ...
  },
  {
    ...
    data: { mood:"proud", growth_points:12, notes:["Body neutrality milestone."] }
  },
  {
    ...
    data: { mood:"burned out", work_stress:8, notes:["Wants more time for art, health, homelessness, hunger, abuse, and recovery work."] }
  },
  {
    ...
    data: { sleep_hours:5, sleep_quality:2, mood:"tired", notes:["Frequently wakes between 2–4 a.m."] }
  },
  {
    ...
    data: { mood:"conflicted", people:["Justin"], relationship_event:"situationship uncertainty", notes:["Wants reciprocity, safety, and clarity."] }
  },
  {
    ...
    data: { mood:"confident", growth_points:10, notes:["Authentic self-expression milestone."] }
  },
  {
    ...
    categories: ["body","growth"],
    data: { squats:100, strength_reps:100, miles:1, workout_minutes:30, exercises:["squats","walking"] }
  },
  {
