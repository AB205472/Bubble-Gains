...
export const SEED_ENTRIES = [
  ...
  },
  {
    ...
    categories: ["body","fun"],
    data: { calories:1850, protein_g:70, miles:0.5, flights:4, exercises:["light swimming","walking","stairs"], notes:["Swimming duration was not provided, so only the documented half mile and four flights affect Agility."] }
  },
  {
  ...
  },
  {
    ...
    data: { mood:"proud", growth_points:2, notes:["Realized she no longer had to suck in to tolerate her body.","Body-neutrality milestone."] }
  },
  {
  ...
  },
  {
    ...
    data: { mood:"confident", growth_points:2, notes:["Realized a more natural look felt more authentic and attractive.","Authentic self-expression milestone."] }
  },
  {
